...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.okverify.android.R.layout.activity_settings);
        dataProvider = new io.okverify.android.database.DataProvider(this);

        settingsBtn = findViewById(io.okverify.android.R.id.settingsbtn);
        closeBtn = findViewById(io.okverify.android.R.id.closebtn);
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String channelId = getString(io.okverify.android.R.string.default_notification_channel_id);
                try {
                    HashMap<String, String> loans = new HashMap<>();
                    loans.put("uniqueId", uniqueId);
                    loans.put("applicationKey", applicationKey);
