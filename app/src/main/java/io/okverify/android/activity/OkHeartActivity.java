...
public class OkHeartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.okverify.android.R.layout.activity_okheart);
        dataProvider = new io.okverify.android.database.DataProvider(this);
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                startForegroundService(new Intent(this, io.okverify.android.services.ForegroundService.class));
            } else {
                startService(new Intent(this, io.okverify.android.services.ForegroundService.class));
            }
        } catch (Exception jse) {
        ...
        */
        ...
        try {
            ...
            File filesDir = new File(getFilesDir() + "/okverify.txt");
            if (filesDir.exists()) {
...
/*
        ...
        */
        ...
        myWebView = OkHeartActivity.this.findViewById(io.okverify.android.R.id.webview);
    ...
    public void startApp() {
        ...
        try {
            ...
            String stuff = "{\n" +
                    ...
                    "      \"version\": \"" + io.okverify.android.BuildConfig.VERSION_NAME + "\",\n" +
                    "      \"build\": \"" + io.okverify.android.BuildConfig.VERSION_CODE + "\",\n" +
